...
#define INCL_WINSWITCHLIST             /* WinQuerySwitchHandle/WinChangeSwitchEntry */
...
static const char bldlevel[] =
    "@#OS2World:1.50#@##1## " __DATE__ "      ARCAOS:::0::::@@Bingo/2 for OS/2 PM\r\n\x1a";
...
/* Global variable definitions (declared extern in BINGO.H) */
LONG   bingonumber;
LONG   numbersdrawn;
USHORT bingoletter;
USHORT bingostatus;
...
PSCOREDATA    psd;
PHISCORESDATA phsd;
PCARDLIST     start, last;
PCARDLIST     startOther, lastOther;
HAB         hab;
HWND        hwndBoard;
HWND        hwndChat;
HWND        hwndHelp;
...
HWND        hwndMenuBar;
BOOL        bFrameVisible;
CHAR szTitle[TITLESIZE+1];
CHAR szText[TEXTSIZE+1];
CHAR szName[TITLESIZE+1];
                                       ...
                                       /* passed are: /D and /N=xxxxx         */
{
 ...
 /* hwndFrame is now a global (see BINGO.H) */
 ...
 /* Capture frame control handles for toggle_frame() */
...
//                                   1, MB_OK | MB_MOVEABLE );
             ...
             case IDM_FRAME:           /* Toggle frame controls               */
                toggle_frame();
                break;
...
/******************************************************************************/
/* toggle_frame: Show or hide frame controls (title bar, sys menu, min/max,   */
/*               menu bar).                                                   */
/******************************************************************************/
...
VOID toggle_frame( VOID )
{
  ...
  if (bFrameVisible)
  {
    ...
    WinShowWindow(hwndTitleBar, TRUE);
    WinShowWindow(hwndSysMenu,  TRUE);
    WinShowWindow(hwndMinMax,   TRUE);
  ...
  /* Nudge window size to force WM_FORMATFRAME */
  WinQueryWindowPos(hwndFrame, &swp);
  w = swp.cx; h = swp.cy;
  WinSetWindowPos(hwndFrame, 0, 0, 0, w + 1, h, SWP_SIZE);
  WinSetWindowPos(hwndFrame, 0, 0, 0, w,     h, SWP_SIZE);
}
...
/* � ���ĳ�   �����������������  ����������������Ĵ�     �     ��  V      �   */
/* yl    �� N ��0,2 31�1,2 32�    �13,2 44�14,2 45������������Ĵ������  yTop  */
/* �     ��   �����������������  ����������������Ĵ�           ��  A      �   */
...
/*  ����ĳ����������������������������������������ٳ        �                 */
/*  ����ĳ���������������������������������������Ŀ�        �                 */
/*   A   ��0,0   1�0,1  16�0,2  31�0,3  46�0,4  61��        �    ��� yboard   */
/*   �   ����������������������������������������Ĵ�        �    �            */
